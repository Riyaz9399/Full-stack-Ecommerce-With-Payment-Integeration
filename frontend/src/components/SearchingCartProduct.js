        ...
        <div className='grid grid-cols-[repeat(auto-fit,minmax(260px,300px))] justify-center md:justify-between md:gap-5 overflow-x-scroll scrollbar-none transition-all'>
            {loading ? (
                ...
                data.map((product, index) => {
                    ...
                    return (
                        <Link key={product?._id || index} to={"/product/" + product?._id} className='w-full min-w-[280px]  md:min-w-[300px] max-w-[280px] md:max-w-[300px]  bg-white rounded-sm shadow'>
                            ...
                            <div className='p-4 grid gap-3'>
                                ...
                                <p className='capitalize text-slate-500'>{product?.category || 'Uncategorized'}</p>
                                <div className='flex gap-3'>
...
export default SearchingCartProduct;
